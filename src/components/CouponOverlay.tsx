  ...
  return (
    ...
    >
      ...
      <div className="aspect-[4/3] bg-gradient-to-br from-blue-500 to-purple-600 relative">
        <img src={`/placeholder.svg?height=300&width=400`} alt={coupon.title} className="w-full h-full object-cover" />
        ...
        <div
          className={`absolute inset-0 bg-black bg-opacity-80 p-6 flex flex-col justify-between transition-opacity duration-300 ${
